  ...
  return (
    <div className="container">
      ...
      <section>
        ...
        <h3>🎓 Courses</h3>
        <ul>{recommendations.courses.map((item, i) => <li key={i}><strong>{item.title}</strong><br /><span>{item.description}</span> <br /><a href={item.link} target="_blank">View</a></li>)}</ul>
        <h3>🎖️ Certifications</h3>
        <ul>{recommendations.certifications.map((item, i) => <li key={i}><strong>{item.title}</strong><br /><span>{item.description}</span> <br /><a href={item.link} target="_blank">View</a></li>)}</ul>
        <h3>💼 Jobs</h3>
        <ul>{recommendations.jobs.map((item, i) => <li key={i}><strong>{item.title}</strong><br /><span>{item.description}</span> <br /><a href={item.link} target="_blank">View</a></li>)}</ul>
      </section>
